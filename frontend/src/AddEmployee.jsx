		...
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<form class="row g-3 w-50" onSubmit={handleSubmit}>
				...
				<div class="col-12">
					...
					<input type="password" class="form-control" id="inputPassword" placeholder="Enter Password" autocomplete="current-password"
				...
				<div class="col-12">
					...
					<input type="text" class="form-control" id="inputAddress" placeholder="Enter Adddress" autoComplete='off'
